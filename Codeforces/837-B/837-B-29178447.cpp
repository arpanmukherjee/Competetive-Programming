...
bool checkR(int x,int y,int n,int m)
{
	if(debug)
	{
		cout<<"For Red: ";
...
bool checkG(int x,int y,int n,int m)
{
	if(debug)
	{
		cout<<"For Green: ";
...
int main()
{
	...
	if(n%3==0)
	{
		if(checkR(0,0,(n/3)-1,m-1) and checkG(n/3,0,((n/3)<<1)-1,m-1) and checkB(((n/3)<<1),0,n-1,m-1))
		{
			puts("YES");
			return 0;
		}
		
		if(checkR(0,0,(n/3)-1,m-1) and checkB(n/3,0,((n/3)<<1)-1,m-1) and checkG(((n/3)<<1),0,n-1,m-1))
		{
			puts("YES");
			return 0;
		}
		
		if(checkB(0,0,(n/3)-1,m-1) and checkG(n/3,0,((n/3)<<1)-1,m-1) and checkR(((n/3)<<1),0,n-1,m-1))
		{
			puts("YES");
			return 0;
		}
		
		if(checkB(0,0,(n/3)-1,m-1) and checkR(n/3,0,((n/3)<<1)-1,m-1) and checkG(((n/3)<<1),0,n-1,m-1))
		{
			puts("YES");
			return 0;
		}
		
		if(checkG(0,0,(n/3)-1,m-1) and checkR(n/3,0,((n/3)<<1)-1,m-1) and checkB(((n/3)<<1),0,n-1,m-1))
		{
			puts("YES");
			return 0;
		}
		
		if(checkG(0,0,(n/3)-1,m-1) and checkB(n/3,0,((n/3)<<1)-1,m-1) and checkR(((n/3)<<1),0,n-1,m-1))
		{
			puts("YES");
			return 0;
		}
	...
	if(m%3==0)
	{
		if(checkR(0,0,n-1,(m/3)-1) and checkG(0,m/3,n-1,((m/3)<<1)-1) and checkB(0,((m/3)<<1),n-1,m-1))
		{
			puts("YES");
			return 0;
		}
		
		if(checkR(0,0,n-1,(m/3)-1) and checkB(0,m/3,n-1,((m/3)<<1)-1) and checkG(0,((m/3)<<1),n-1,m-1))
		{
			puts("YES");
			return 0;
		}
		
		if(checkG(0,0,n-1,(m/3)-1) and checkR(0,m/3,n-1,((m/3)<<1)-1) and checkB(0,((m/3)<<1),n-1,m-1))
		{
			puts("YES");
			return 0;
		}
		
		if(checkG(0,0,n-1,(m/3)-1) and checkB(0,m/3,n-1,((m/3)<<1)-1) and checkR(0,((m/3)<<1),n-1,m-1))
		{
			puts("YES");
			return 0;
		}
		
		if(checkB(0,0,n-1,(m/3)-1) and checkG(0,m/3,n-1,((m/3)<<1)-1) and checkR(0,((m/3)<<1),n-1,m-1))
		{
			puts("YES");
			return 0;
		}
		
		if(checkB(0,0,n-1,(m/3)-1) and checkR(0,m/3,n-1,((m/3)<<1)-1) and checkG(0,((m/3)<<1),n-1,m-1))
		{
			puts("YES");
			return 0;
		}
